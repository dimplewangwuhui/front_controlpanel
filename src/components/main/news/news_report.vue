<template>
  <div class="news_report" v-loading="loading">
    <el-tabs :tab-position="tabPosition">
      <el-tab-pane label="北京市热点新闻">
...
<script>
  ...
  export default {
    ...
    methods:{
      getNews(){
        this.$axios.get('http://127.0.0.1:5000/getNewsReport')
          .then((response) => {
